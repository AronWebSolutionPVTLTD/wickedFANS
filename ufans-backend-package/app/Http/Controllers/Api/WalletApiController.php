...
class WalletApiController extends Controller
{
    ...
    public function user_withdrawals_send_request(Request $request) {
        ...
        try {
            ...
            $balance_wallet = $remaining - $request->requested_amount;
            ...
            if($balance_wallet < $user_withdrawals_min_balance) {
                ...
                throw new Exception(api_error(267, $min_balance_formatted), 267);
            }
    ...
    /**
     * @method user_wallets_generate_stripe_payment()
     *
     * @uses Generate client secret for wallet payment - https://stripe.com/docs/payments/quickstart
     *
     * @created Vithya R
     *
     * @updated Vithya R
    ...
    public function user_wallets_generate_stripe_payment(Request $request) {
        ...
        try {
            ...
            $stripe_payment_intent = \Stripe\PaymentIntent::create([
                ...
                'description' => Setting::get('site_name'),
                'shipping' => [
                    'name' => $user->name ?: "",
                    'address' => [
                        'line1' => $user->address ?: "",
