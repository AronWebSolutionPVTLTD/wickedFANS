...
export const MainLanding = () => {
  ...
  <div className="main-wrpper" > 
      ...
      <div className="container">
        <nav className="navbar navbar-expand-md navbar-light">
          <Link className="navbar-brand" href="index.html">
            <img loading="lazy" src="images/logo@4x.png" alt="Logo" />
          </Link>
          <button
        ...
        <div className="row">
          <div className="col-md-6 col-sm-12">
            <div className="banner-data">
              ...
              <div className="coinbase">
                <img loading="lazy" src="images/coinbase.png" alt="coinbase" />
              </div>
          ...
          <div className="col-md-6 col-sm-12">
            <div className="banner-img">
              <img loading="lazy" src="images/1-banner-img.png" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="sponcer-slider">
          <Slider {...settings}>
            <div className="sponcer-img">
              <img loading="lazy" src="images/sponcer-img1.png" alt="" />
            </div>
            <div className="sponcer-img">
              <img loading="lazy" src="images/sponcer-img2.png" alt="" />
            </div>
            <div className="sponcer-img">
              <img loading="lazy" src="images/sponcer-img3.png" alt="" />
            </div>
            <div className="sponcer-img">
              <img loading="lazy" src="images/sponcer-img4.png" alt="" />
            </div>
            <div className="sponcer-img">
              <img loading="lazy" src="images/sponcer-img5.png" alt="" />
            </div>
        </Slider>
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4 col-sm-12">
            <div className="why-box">
              <div className="why-ic">
                <img loading="lazy" src="images/why-ic1.svg" alt="" />
              </div>
          ...
          <div className="col-md-4 col-sm-12">
            <div className="why-box">
              <div className="why-ic">
                <img loading="lazy" src="images/why-ic2.svg" alt="" />
              </div>
          ...
          <div className="col-md-4 col-sm-12">
            <div className="why-box">
              <div className="why-ic">
                <img loading="lazy" src="images/why-ic3.svg" alt="" />
              </div>
              <h3>Earn money</h3>
              <p>
      ...
      <div className="container">
        ...
        <div className="ambassadors-block">
            <div className="ambassadors-img">
              <img loading="lazy" src="images/model-img1.png" alt="" />
            </div>
            <div className="personal-infobx">
              ...
              <div className="connect-us">
                <Link to="" target="_blank">
                  <img loading="lazy" src="images/social-ic1.png" alt="" />
                </Link>
                <Link to="" target="_blank">
                  <img loading="lazy" src="images/social-ic2.png" alt="" />
                </Link>
                <Link to="" target="_blank">
                  <img loading="lazy" src="images/social-ic3.png" alt="" />
                </Link>
              </div>
            </div>
          </div>
          <div className="ambassadors-block">
            <div className="ambassadors-img">
              <img loading="lazy" src="images/model-img2.png" alt="" />
            </div>
            <div className="personal-infobx">
              <h3>Melvin Lamberty</h3>
              <h6>@melvinlamberty</h6>
          ...
          <div className="ambassadors-block">
            <div className="ambassadors-img">
              <img loading="lazy" src="images/model-img3.png" alt="" />
            </div>
            <div className="personal-infobx">
              <h3>Melvin Lamberty</h3>
              <h6>@melvinlamberty</h6>
          ...
          <div className="ambassadors-block">
            <div className="ambassadors-img">
              <img loading="lazy" src="images/model-img4.png" alt="" />
            </div>
            <div className="personal-infobx">
              <h3>Melvin Lamberty</h3>
              <h6>@melvinlamberty</h6>
        ...
        <div className="row">
          <div className="col-md-6 col-sm-12">
            <div className="creation-img">
              <img loading="lazy" src="images/creation-img.png" alt="" />
            </div>
          </div>
          <div className="col-md-6 col-sm-12">
          ...
          <div className="row">
            ...
            <div className="col-md-5 col-sm-12">
              <div className="signup-img">
                <img loading="lazy" src="images/signup-img.png" alt="" />
              </div>
            </div>
          </div>
        </div>
    ...
    <section className="testimonial-wrp">
      <div className="container">
        ...
        <div className="testimonials-box">
            <div className="raitingbx">
              <img loading="lazy" src="images/star-ic.svg" alt="" />
              <img loading="lazy" src="images/star-ic.svg" alt="" />
              <img loading="lazy" src="images/star-ic.svg" alt="" />
              <img loading="lazy" src="images/star-ic.svg" alt="" />
              <img loading="lazy" src="images/star-ic.svg" alt="" />
      ...
      {/* <img loading="lazy" src="images/banner-shp1.png" alt="" class="signup-shp2">
          <img loading="lazy" src="images/mobile-shp2.png" alt="" class="mobile-shp2">  */}
    </section>
    {/* End Testimonial */}
    {/* FAQ */}
      ...
      <div className="container">
        <div className="signup-row">
          <div className="row">
            ...
            <div className="col-md-5 col-sm-12">
              <div className="signup-img">
                <img loading="lazy" src="images/crypto-img.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-5 col-sm-12">
            <div className="footer-abt">
              <img loading="lazy" src="images/logo@4x.png" alt="footer-logo" />
              <p>
              ...
              <div className="social-box">
                <Link to="" target="_blank">
                  <img loading="lazy" src="images/tiktok-ic.png" alt="" />
                </Link>
                <Link to="" target="_blank">
