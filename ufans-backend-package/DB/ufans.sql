...
--
-- Host: localhost:3306
-- Generation Time: Jan 28, 2023 at 12:07 PM
...
CREATE TABLE `admins` (
  ...
  `picture` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/placeholder.jpeg',
...
(1, 'admin-demo', 'Admin', 'demo@demo.com', '$2y$10$pj1c75iEYzbGssQKhY.fm.otsyLC8NGD/WinWALHd/BUF4NGUsNra', 'About', 'http://localhost:8000/placeholder.jpeg', 'Asia/Kolkata', 'male', 1, NULL, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(2, 'admin-demo', 'Test', 'test@demo.com', '$2y$10$sXL/iCt6MAVjs5mxIS8Y3.pggonMI2zaHI5RRHWzEKIOB9yguneZG', 'About', 'http://localhost:8000/placeholder.jpeg', 'Asia/Kolkata', 'male', 1, NULL, '2023-01-28 01:03:41', '2023-01-28 01:03:41');
...
CREATE TABLE `audio_call_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '795487661',
...
CREATE TABLE `audio_call_requests` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1565653601',
  `user_id` int NOT NULL,
  `model_id` int NOT NULL,
  `agora_token` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c3175ea',
  `virtual_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c3175ed',
...
CREATE TABLE `audio_chat_messages` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1500456145',
  `audio_call_request_id` int NOT NULL,
  `model_id` int NOT NULL,
  `user_id` int NOT NULL,
...
CREATE TABLE `bell_notifications` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '81853225',
...
CREATE TABLE `carts` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '165322396',
  `user_id` int NOT NULL,
...
CREATE TABLE `categories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '954773227',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `picture` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/cat-placeholder.jpeg',
  `status` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `category_details` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1044451765',
...
CREATE TABLE `chat_assets` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '861338427',
  `from_user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
...
CREATE TABLE `chat_asset_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '607989061',
  `from_user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
  `chat_message_id` int NOT NULL,
  `user_card_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `chat_messages` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '661389885',
  `from_user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  ...
  `token` double(8,2) NOT NULL DEFAULT '0.00',
  `is_paid` tinyint NOT NULL DEFAULT '0',
  `file_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `chat_users` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '386915579',
  `from_user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
  `status` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `delivery_addresses` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1406904692',
  `user_id` int NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `documents` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '617018372',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'jpg',
  `picture` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/document.jpg',
  `description` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `faqs` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1510692816',
...
CREATE TABLE `fav_users` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '534579356',
  `user_id` int NOT NULL,
...
CREATE TABLE `hashtags` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '526259690',
...
CREATE TABLE `live_videos` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1382568688',
  `user_id` int NOT NULL,
  `agora_token` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c2b4fe4',
  `virtual_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c2b4fe7',
  ...
  `snapshot` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/images/live-streaming.jpeg',
...
CREATE TABLE `live_video_chat_messages` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '367106784',
  `from_user_id` int NOT NULL,
...
CREATE TABLE `live_video_payments` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1388181136',
...
(20, '2022_05_26_105728_create_product_categories_table', 1),
(21, '2022_06_27_110854_add_tips_type_field_to_user_tips_table', 1),
(22, '2022_07_19_102008_create_currencies_table', 1),
(23, '2022_07_25_131007_add_device_unique_id_field_to_user_login_sessions_table', 1),
(24, '2022_08_05_114016_change_static_pages_description_field_datatype_from_text_to_long_text', 1),
(25, '2022_11_28_110831_add_file_type_fields_to_chat_messages', 1),
(26, '2023_01_13_064222_add_country_to_delivery_addresses_table', 1);
...
CREATE TABLE `orders` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '168470186',
  `user_id` int NOT NULL,
...
CREATE TABLE `order_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '458019611',
  `user_id` int NOT NULL,
  `order_id` int NOT NULL,
  `payment_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_mode` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CARD',
...
CREATE TABLE `order_products` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1984510285',
  `user_id` int NOT NULL,
  `order_id` int NOT NULL,
  `user_product_id` int NOT NULL,
  `quantity` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `posts` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '2115418347',
  `user_id` int NOT NULL,
...
CREATE TABLE `post_albums` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '797330824',
  `user_id` int NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` tinyint NOT NULL DEFAULT '1',
...
CREATE TABLE `post_album_files` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1922164439',
...
CREATE TABLE `post_bookmarks` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1360400836',
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
  `status` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `post_comments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1830372947',
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
...
CREATE TABLE `post_comment_likes` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '197318593',
  `user_id` int NOT NULL,
  `post_comment_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `post_comment_replies` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '906052983',
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
...
CREATE TABLE `post_files` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1311707204',
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
  `file` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `blur_file` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `post_hashtags` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '202792659',
  `user_id` int NOT NULL DEFAULT '0',
  `post_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `post_likes` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '2097335914',
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
  `post_user_id` int NOT NULL,
  `status` tinyint NOT NULL DEFAULT '1',
...
CREATE TABLE `post_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1613703017',
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
  `user_card_id` int NOT NULL DEFAULT '0',
  `payment_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `product_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1673305570',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `picture` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/cat-placeholder.jpeg',
  `status` tinyint NOT NULL DEFAULT '1',
...
CREATE TABLE `product_inventories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1646612933',
  `user_product_id` int NOT NULL,
...
CREATE TABLE `product_sub_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1491814460',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `promo_codes` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c0e251b',
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `referral_codes` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1666909022',
  `user_id` int NOT NULL,
...
CREATE TABLE `report_posts` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '261383419',
  `post_id` int NOT NULL,
  `block_by` int NOT NULL,
...
CREATE TABLE `report_reasons` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1612961466',
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `status` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
...
(1, 'site_name', 'UFans', 1, NULL, NULL),
(2, 'frontend_url', '', 1, NULL, NULL),
(3, 'tag_name', '', 1, NULL, NULL),
(4, 'site_logo', 'http://localhost:8000;/logo.png', 1, NULL, NULL),
(5, 'site_icon', 'http://localhost:8000;/favicon.png', 1, NULL, NULL),
...
(52, 'post_video_placeholder', 'http://localhost:8000/images/post_video_placeholder.jpg', 1, NULL, NULL),
...
(57, 'frontend_no_data_image', 'http://localhost:8000/images/no-data-found.svg', 1, NULL, NULL),
(58, 'is_mailgun_email_validate', '0', 1, NULL, NULL),
(59, 'user_online_status_limit', '0', 1, NULL, NULL),
(60, 'FB_CLIENT_ID', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(61, 'FB_CLIENT_SECRET', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(62, 'FB_CALL_BACK', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(63, 'TWITTER_CLIENT_ID', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(64, 'TWITTER_CLIENT_SECRET', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(65, 'TWITTER_CALL_BACK', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(66, 'GOOGLE_CLIENT_ID', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(67, 'GOOGLE_CLIENT_SECRET', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(68, 'GOOGLE_CALL_BACK', '', 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
...
(79, 'product_admin_commission', '10', 1, NULL, NULL),
(80, 'is_notification_count_enabled', '0', 1, NULL, NULL),
(81, 'notification_time', '', 1, NULL, NULL),
(82, 'is_paypal_enabled', '1', 1, NULL, NULL),
(83, 'PAYPAL_ID', 'AaXkweZD5g9s0X3BsO0Y4Q-kNzbmLZaog0mbmVGrTT5IX0O73LoLVcHp17e6pkG7Vm04JEUuG6up30LD', 1, NULL, NULL),
(84, 'PAYPAL_SECRET', '', 1, NULL, NULL),
(85, 'PAYPAL_MODE', 'sandbox', 1, NULL, NULL),
(86, 'is_user_allowed_verified_badge', '0', 1, NULL, NULL),
(87, 'verified_badge_file', 'http://localhost:8000/images/verified.svg', 1, NULL, NULL),
(88, 'verified_badge_text', 'Verified', 1, NULL, NULL),
(89, 'is_multilanguage_enabled', '1', 1, NULL, NULL),
(90, 'is_welcome_steps', '1', 1, NULL, NULL),
(91, 'video_call_admin_commission', '10', 1, NULL, NULL),
(92, 'video_call_start_plus_minus', '10', 1, NULL, NULL),
(93, 'is_one_to_one_call_enabled', '1', 1, NULL, NULL),
(94, 'is_one_to_many_call_enabled', '1', 1, NULL, NULL),
(95, 'audio_call_admin_commission', '10', 1, NULL, NULL),
(96, 'audio_call_start_plus_minus', '10', 1, NULL, NULL),
(97, 'is_watermark_logo_enabled', '0', 1, NULL, NULL),
(98, 'watermark_logo', 'http://localhost:8000/images/watermark.png', 1, NULL, NULL),
(99, 'watermark_position', 'top-left', 1, NULL, NULL),
(100, 'live_streaming_placeholder_img', 'http://localhost:8000/images/livestreaming_placeholder.jpg', 1, NULL, NULL),
(101, 'live_streaming_admin_commission', '0', 1, NULL, NULL),
(102, 'agora_app_id', '', 1, NULL, NULL),
(103, 'agora_certificate_id', '', 1, NULL, NULL),
(104, 'is_agora_configured', '0', 1, NULL, NULL),
(105, 'snapchat_link', '', 1, NULL, NULL),
(106, 'youtube_link', '', 1, NULL, NULL),
(107, 'google_plus_link', '', 1, NULL, NULL),
(108, 'is_coinpayment_enabled', '0', 1, NULL, NULL),
(109, 'referral_earnings', '10', 1, NULL, NULL),
(110, 'referrer_earnings', '10', 1, NULL, NULL),
(111, 'is_referral_enabled', '1', 1, NULL, NULL),
(112, 'is_chat_asset_enabled', '1', 1, NULL, NULL),
(113, 'profile_placeholder', 'http://localhost:8000/placeholder.jpeg', 1, NULL, NULL),
(114, 'cover_placeholder', 'http://localhost:8000/cover.jpg', 1, NULL, NULL),
(115, 'post_image_placeholder', 'http://localhost:8000/images/post_image_placeholder.jpg', 1, NULL, NULL),
(116, 'video_call_placeholder', 'http://localhost:8000/images/video_call_placeholder.jpg', 1, NULL, NULL),
(117, 'audio_call_placeholder', 'http://localhost:8000/images/audio_call_placeholder.jpg', 1, NULL, NULL),
(118, 'ppv_image_placeholder', 'http://localhost:8000/images/ppv_image_placeholder.jpg', 1, NULL, NULL),
(119, 'ppv_audio_placeholder', 'http://localhost:8000/images/ppv_audio_placeholder.jpg', 1, NULL, NULL),
(120, 'ppv_video_placeholder', 'http://localhost:8000/images/ppv_video_placeholder.jpg', 1, NULL, NULL),
(121, 'asset_placeholder', 'http://localhost:8000/images/asset_placeholder.jpg', 1, NULL, NULL),
(122, 'is_stripe_enabled', '1', 1, NULL, NULL),
(123, 'is_ads_enabled', '0', 1, NULL, NULL),
(124, 'header_ad', '', 1, NULL, NULL),
(125, 'footer_ad', '', 1, NULL, NULL),
(126, 'sidebar_ad', '', 1, NULL, NULL),
(127, 'is_ccbill_enabled', '0', 1, NULL, NULL),
(128, 'ccbill_url', '', 1, NULL, NULL),
(129, 'ccbill_account_number', '', 1, NULL, NULL),
(130, 'ccbill_sub_account_number', '', 1, NULL, NULL),
(131, 'flex_form_id', '', 1, NULL, NULL),
(132, 'salt_key', '', 1, NULL, NULL),
(133, 'buy_single_user_products', '0', 1, NULL, NULL),
(134, 'NOCAPTCHA_SECRET_KEY', '', 1, NULL, NULL),
(135, 'NOCAPTCHA_SITE_KEY', '', 1, NULL, NULL),
(136, 'is_captcha_enabled', '0', 1, NULL, NULL),
(137, 'is_only_wallet_payment', '1', 1, NULL, NULL),
(138, 'is_wallet_payment_enabled', '1', 1, NULL, NULL),
(139, 'token_symbol', 'Token', 1, NULL, NULL),
(140, 'token_amount', '1', 1, NULL, NULL),
(141, 'tip_min_token', '1', 1, NULL, NULL),
(142, 'tip_max_token', '10000', 1, NULL, NULL),
(143, 'symbol_position', 'suffix', 1, NULL, NULL);
...
CREATE TABLE `static_pages` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c10aee7',
...
(1, 'about', 'about', 'about', 'about', NULL, 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(2, 'contact', 'contact', 'contact', 'contact', NULL, 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(3, 'privacy', 'privacy', 'privacy', 'privacy', NULL, 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(4, 'terms', 'terms', 'terms', 'terms', NULL, 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41'),
(5, 'help', 'help', 'help', 'help', NULL, 1, '2023-01-28 01:03:41', '2023-01-28 01:03:41');
...
CREATE TABLE `stories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '477549556',
  `user_id` int NOT NULL DEFAULT '0',
  `content` text COLLATE utf8mb4_unicode_ci,
  `publish_time` datetime DEFAULT NULL,
  `token` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `story_files` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1210157777',
  `user_id` int NOT NULL DEFAULT '0',
  `story_id` int NOT NULL DEFAULT '0',
  `file` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/placeholder.jpeg',
  `blur_file` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/placeholder.jpeg',
  `file_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'image',
  `preview_file` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/placeholder.jpeg',
  `status` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `subscriptions` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '420858528',
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `subscription_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1bfd1c22',
...
CREATE TABLE `sub_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '741809816',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `support_chats` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '312619439',
  `user_id` int NOT NULL,
...
CREATE TABLE `support_members` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '283149655',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `support_tickets` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1150903389',
  `user_id` int NOT NULL,
  `support_member_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `users` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '297381353',
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `first_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `middle_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `last_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `cover` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/cover.jpg',
  `picture` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/placeholder.jpeg',
  `password` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mobile` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
(1, 'user-demo', 'User', 'User', '', 'Demo', 'user-demo', 'demo@demo.com', NULL, 'rather-not-select', 'http://localhost:8000/cover.jpg', 'http://localhost:8000/placeholder.jpeg', '$2y$10$XizvC1uE6r76lpJCKQvrEeRo.sFngzDS4FxmXj.M9g98AMf.oMi1G', '9836367763', '', '', '', 0, 0, 0, 'CARD', '2y10v2eTGkbvqy3x1qnZ8JSKXeFL8tR3CZTDfvrvprW1bMRrhrqtTrbz6', '37674887621', NULL, 'web', 'manual', '', 0, 1, 1, 0, 1, '', '', NULL, 1, 'WALLET', 1, 0, 0.00, NULL, 0, 0.00, 0.00, 0.00, 0.00, NULL, NULL, 0, 0, '2023-01-28 01:03:41', '2023-01-28 01:03:41', 0, 1, 0, 0, '', '', '', '', '', '', '', '', '', 0, 0.00000000, 0.00000000, ''),
(2, 'user-test', 'Test', 'User', '', 'Test', 'user-test', 'test@demo.com', NULL, 'rather-not-select', 'http://localhost:8000/cover.jpg', 'http://localhost:8000/placeholder.jpeg', '$2y$10$VkuKhO8mCFqghgkdgJFVvebsK5Zh.Jlcbzp5aD2X8IykjVjdiHoyO', '9836367763', '', '', '', 0, 0, 0, 'CARD', '2y10xBE68rZ6l4D5mUbHa3WYze0p1EOxRLNHMQzV0HUuctfWdUbot6xG', '37674887621', NULL, 'web', 'manual', '', 0, 1, 1, 0, 1, '', '', NULL, 1, 'WALLET', 1, 0, 0.00, NULL, 0, 0.00, 0.00, 0.00, 0.00, NULL, NULL, 0, 0, '2023-01-28 01:03:41', '2023-01-28 01:03:41', 0, 1, 0, 0, '', '', '', '', '', '', '', '', '', 0, 0.00000000, 0.00000000, '');
...
CREATE TABLE `user_cards` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1bfe4f94',
  `user_id` int NOT NULL,
...
CREATE TABLE `user_documents` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '908418450',
  `user_id` int NOT NULL,
...
CREATE TABLE `user_login_sessions` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1330796229',
  `user_id` int NOT NULL DEFAULT '0',
  `device_type` enum('web','android','ios') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'web',
...
CREATE TABLE `user_products` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '2017450948',
  `user_id` int NOT NULL,
  `product_category_id` int NOT NULL,
  `product_sub_category_id` int NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `picture` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http://localhost:8000/product-placeholder.jpeg',
  `quantity` double(8,2) NOT NULL DEFAULT '0.00',
  `token` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `user_product_pictures` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1422553754',
  `user_product_id` int NOT NULL,
...
CREATE TABLE `user_referrals` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1079443947',
  `user_id` int NOT NULL,
...
CREATE TABLE `user_subscriptions` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1295369292',
  `user_id` int NOT NULL,
...
CREATE TABLE `user_subscription_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c03bd90',
...
CREATE TABLE `user_tips` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1947291530',
  `user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
  `post_id` int NOT NULL DEFAULT '0',
  `amount` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `user_wallets` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '2112563648',
  `user_id` int NOT NULL,
  `total` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `user_wallet_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '221430534',
  `user_id` int NOT NULL,
...
CREATE TABLE `user_withdrawals` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1473614999',
  `user_id` int NOT NULL,
  `user_wallet_payment_id` int NOT NULL DEFAULT '0',
  `payment_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `vc_chat_messages` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1657933241',
...
CREATE TABLE `verification_codes` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1498539212',
...
CREATE TABLE `video_call_requests` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '631345439',
  `user_id` int NOT NULL,
  `model_id` int NOT NULL,
  `call_status` int NOT NULL DEFAULT '0',
  `start_time` datetime DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `agora_token` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c37d1aa',
  `virtual_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c37d1ad'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `viewers` (
  `id` int UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1415079740',
  `live_video_id` int NOT NULL,
  `user_id` int NOT NULL,
  `count` int NOT NULL DEFAULT '0',
  `status` tinyint NOT NULL DEFAULT '1',
...
CREATE TABLE `vod_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '903932321',
...
CREATE TABLE `vod_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '63d4c1c30643e',
  `from_user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
  `payment_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `token` double(8,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `vod_videos` (
  `id` bigint UNSIGNED NOT NULL,
  `unique_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1624779197',
  `user_id` int NOT NULL DEFAULT '0',
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` text COLLATE utf8mb4_unicode_ci,
  `publish_time` datetime DEFAULT NULL,
