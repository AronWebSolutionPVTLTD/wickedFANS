...
class User extends Authenticatable
{
    ...
    public function chatassetPayments() {
        ...
        return $this->hasMany(ChatAssetPayment::class,'from_user_id');
    }  

    public function livevideoPayments() {

        return $this->hasMany(LiveVideoPayment::class,'user_id');
    }
    ...
    public function videocallPayments() {
        ...
        return $this->hasMany(VideoCallPayment::class,'user_id');
    }
    ...
    public function getVideoCallAmountFormattedAttribute() {
		...
		return formatted_amount($this->video_call_amount ?? 0.00);
    }

    public function getAudioCallAmountFormattedAttribute() {

        return formatted_amount($this->audio_call_amount ?? 0.00);
    }
    ...
    public static function boot() {
        ...
        static::deleting(function ($model){
            ...
            \App\Models\ChatUser::where('from_user_id', $model->id)->delete();
