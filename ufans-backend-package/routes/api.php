...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => 'cors'], function () {
    ...
    Route::group(['middleware' => 'UserApiVal'], function () {
        ...
        Route::post('wallets_generate_stripe_payment', 'Api\WalletApiController@user_wallets_generate_stripe_payment');
    ...
    Route::group(['middleware' => 'UserApiVal'], function () {
        ...
        Route::post('user_chat_assets', 'Api\ChatApiController@user_chat_assets');

        Route::post('chat_asset_files_upload', 'Api\ChatApiController@chat_asset_files_upload');

        Route::post('chat_asset_files_remove', 'Api\ChatApiController@chat_asset_files_remove');
