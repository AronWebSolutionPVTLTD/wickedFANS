...
return [
	...
	"total" => "Total",
	"post__payment_search_placeholder" => "Search By User Name, Post Id,Payment Id",
	...
	"order_payment_search_placeholder" => "Search By User Name, Payment Id,Order Id",
	"products" => "Products",
	...
	'product_sub_categories_search_placeholder' => 'Search by Product Category,Sub Category Name',
	'choose_product_sub_category' => 'choose Product Sub Category',
	...
	"live_video_payment_invoice_message" => "You Invoice for the Live Video Payments",
	"video_call_payment_invoice_message" => "You Invoice for the Video call Payments",
	...
	'call_request_search_placeholder' => 'Search by User Name, Model,Request Id',
	...
	'post_payments_settings_notes' => 'Note: Admin will get commission based on the below percentage for each payments for the posts.',
	'live_streaming_admin_commission_notes' => 'Note: Admin will get commission based on the below percentage for each payments for the live videos (1 to Many)',
	'tips_admin_commission_notes' => 'Note: Admin will get commission based on the below percentage for each payments for the tips.',
	'subscription_admin_commission_notes' => 'Note: Admin will get commission based on the below percentage for each payments for the subscriptions.',
	'video_call_admin_commission_notes' => 'Note: Admin will get commission based on the below percentage for each payments for the video calls (1 to One)',
	...
	"audio_call_admin_commission_notes" => 'Note: Admin will get commission based on the below percentage for each payments for the audio calls (1 to One)',
	...
	"bookmarked_at" => "Bookmarked At",
	"billing_accounts" => "View Billing Accounts",
	"blocked_by" => "Blocked By",
	"unblock_accounts" => "Do you want to unblock For All Accounts?",
	"rejected_at" => "Rejected At",
	"requested_amount" => "Requested Amount",
	"paid_amount" => "Paid Amount",
	"add_sub_category" => "Add sub Category",
	"view_hashtag" => "View HashTags",
	"edit_hashtag" => "Edit Hashtag",
	"payment_cancelled" => "Cancellation Of Subscription",
	"shipping_detail" => "Shipping Address",
	"selected_status" => "Request Status",
	"schedule_date" => "Scheduled Date&Time",
	"view_request" => "Request Id",
	"order_payment" => "Payment Earnings",
	"post_payments" => "Post Payment",
	"available" => "Is Available",
	"is_payment_cancel" => "Cancellation Of Subscription",
	"ORDER_NONE" => "Pending",
	"ORDER_PLACED" => "Placed",
	"ORDER_SHIPPED" => "Shipped",
	"ORDER_DELIVERD" => "Deliverd",
	"ORDER_CACELLED" => "Cancelled",
	"ORDER_PACKED" => "Packed",
	"cart_remove_failed" => "Product Remove Failed",
	"cart_removed_success" => "Product Removed",
	"post_likes_search_placeholder" => "Search By Content Creator Name",
	"view_post" => "View Post",
	"paid_at" => "Subscribed At",
	"request_status" => "Request Status",
	'cart_removed_success' => 'Product Removed',
	'cart_remove_failed' => 'Product Remove Failed.',
	'post_details' => 'Post Details',
	'view_post' => 'View Post',
	'cancellation_of_subscription' => 'Cancellation Of Subscription',
	'subscribed_at' => 'Subscribed At',
	'view_live_video' => 'View Live Video',
	'view_product_sub_category' => 'View Subcategory',
	'view_product_category' => 'View Category',
	"admin_commission_note" => "Note : Admin will get commission in " . Setting::get('token_symbol'),
	"user_withdrawal_wallet_payment_not_found" => "The user wallet payment details not found for the selected user withdrawal.",
	"monthly_subscription" => "Monthly Subscription Amount",
	"yearly_subscription" => "Yearly Subscription Amount",
	"select_availability_status" => "Select Availability Status",
	"user_products" => "Product Details",
	"total_duration" => "Total Duration",
	"bussiness_name" => "Bussiness Name",
	"revenue_details" => "Revenu Details",
	"verified_badge_settings" => "Verified Badge Settings",
	"demo_login_details" => "Demo Login Details",
	"frontend_settings" => "Frontend Settings",
	"push_notification_links" => "Push Notification Links",
	"live_video_call_settings" => "Live Video Call Settings",
	"export_to_excel" => "Export to Excel",
	"product_admin_commission" => "Product Admin Commission",
	"order_payments_message" => "You received a order payment (:other_key) from ",
	"withdrawal_settings" => "Withdrawal Settings",
	"user_withdrawals_min_amount" => "Withdrawal Min Amount",
	"user_withdrawals_min_balance" => "Withdrawal Min Balance",

	"btcpay_settings" => "BTCPAY Settings",
	"btcpay_mode" => "Btcpay Mode",
	"btcpay_live" => "Live",
	"btcpay_test" => "Test",
	"btcpay_live_endpoint" => "Btcpay Live Server Endpoint",
	"btcpay_live_api_key" => "Btcpay Live Api key",
	"btcpay_live_store_id" => "Btcpay Live Store ID",
	"btcpay_test_endpoint" => "Btcpay Test Server Endpoint",
