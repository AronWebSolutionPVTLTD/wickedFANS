...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <h3></h3>
    <span class="preheader">{{tr('email_preheader')}}</span>
        ...
        <td align="center">
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>{{tr('hey')}} {{$data['name']}}!!</h1>

                        <p>{{tr('thanks_for_signup')}} {{Setting::get('site_name')}}. {{tr('user_welcome_description')}}
                        </p>

                        <p>
                          <h4>{{tr('verification_code')}}: {{$data['data']['verification_code'] ?? ($data['data']['verification_code'] ?? "")}}</h4>
                        </p>
              ...
              <strong>{{tr('login_page')}}</strong> {{Setting::get('frontend_url')}}
            </span>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="attributes_item">
                                    <span class="f-fallback">
              <strong>{{tr('email')}}</strong> {{$data['email']}}
            </span>
                                  </td>
                                </tr>
                              </table>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">{{tr('you_are_receiving_mails_from')}} {{Setting::get('site_name')}}</p>
                    </td>
                  </tr>
                </table>
              </td>
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                <tr style="border-collapse:collapse;">
                                                    <td align="center" style="padding:0;Margin:0;padding-bottom:5px;">
                                                        <h3 style="Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;">{{tr('social_media')}}</h3>
                                                    </td>
                                                </tr>
                                                <tr style="border-collapse:collapse;">
                                                    <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0;">
                                                        <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                            <tr style="border-collapse:collapse;">
                                                                ...
                                                                <td valign="top" align="center" style="padding:0;Margin:0;"><a href="{{Setting::get('linkedin_link')}}" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#333333;"><img title="Linkedin" src="{{asset('images/linkedin-logo-black.png')}}" alt="Tw" width="32" height="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a></td>
                                                                @endif
                                                                @if(Setting::get('snapchat_link'))
                                                                <td valign="top" align="center" style="padding:0;Margin:0;"><a href="{{Setting::get('snapchat_link')}}" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#333333;"><img title="Linkedin" src="{{asset('images/snapchat-logo-black.png')}}" alt="Tw" width="32" height="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a></td>
                                                                @endif
                                                            </tr>
                                                        </table>
                                                    </td>
