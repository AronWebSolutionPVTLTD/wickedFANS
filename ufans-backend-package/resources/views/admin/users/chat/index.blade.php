            ...
            <div class="card">
                ...
                <div class="card-header border-bottom border-gray">
                    ...
                    <div class="heading-elements">
                        ...
                        <a href="{{ route('admin.chat_asset_payment.excel',['from_user_id'=>Request::get('from_user_id'),'search_key'=>Request::get('search_key'),'status'=>Request::get('status'),'file_format'=>'.csv']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('Export_to_csv')}}</a>

                        <a href="{{ route('admin.chat_asset_payment.excel',['from_user_id'=>Request::get('from_user_id'),'search_key'=>Request::get('search_key'),'status'=>Request::get('status'),'file_format'=>'.xls']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('Export_to_xls')}}</a>

                        <a href="{{ route('admin.chat_asset_payment.excel',['from_user_id'=>Request::get('from_user_id'),'search_key'=>Request::get('search_key'),'status'=>Request::get('status'),'file_format'=>'.xlsx']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('Export_to_xlsx')}}</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="{{route('admin.chat_asset_payments.send_invoice',['chat_asset_payment_id' => $chat_asset_payment->id])}}" class="btn btn-primary"><i class="fa fa-envelope"></i>&nbsp;{{tr('send_invoice')}}</a>
