...
Route::group(['middleware' => 'web'], function() {
    ...
    Route::group(['as' => 'admin.', 'prefix' => 'admin'], function(){
      ...
      // liked posts route start
        ...
        Route::get('video_call_payments/send_invoice', 'Admin\AdminVideoCallRequestController@video_call_payments_send_invoice')->name('video_call_payments.send_invoice');

        Route::get('audio_call_payments/send_invoice', 'Admin\AdminAudioCallRequestController@audio_call_payments_send_invoice')->name('audio_call_payments.send_invoice');

        Route::get('chat_asset_payments/send_invoice', 'Admin\AdminUserController@chat_asset_payments_send_invoice')->name('chat_asset_payments.send_invoice');


        Route::get('live_videos/send_invoice', 'Admin\AdminUserController@live_video_payments_send_invoice')->name('live_videos.payments.send_invoice');
        ...
        Route::get('orders/payments/send_invoice', 'Admin\AdminRevenueController@order_payments_send_invoice')->name('order.payments.send_invoice');

        Route::get('user_tips/send_invoice', 'Admin\AdminRevenueController@user_tip_payments_send_invoice')->name('user_tips.send_invoice');
        ...
        Route::get('hashtags/edit', 'Admin\AdminPostController@hashtags_edit')->name('hashtags.edit');
