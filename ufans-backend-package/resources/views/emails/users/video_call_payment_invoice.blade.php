        ...
        <td class="attributes_content">
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <tr style="padding-bottom:30px !important;">
                    <td class="attributes_item">
                        <span class="f-fallback">
                            <strong>{{tr('date')}}:</strong> {{common_date($data['video_call_payments']['paid_date'], $data['timezone'], 'd M Y')}}
                        </span>
                    </td>
                </tr>
            </table>
...
<table class="purchase" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <h3>{{$data['video_call_payments']['payment_id'] ?? ''}}</h3>
        </td>
        <td>
            <h3 class="align-right">{{common_date($data['video_call_payments']['paid_date'], $data['timezone'], 'd M Y')}}</h3>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="80%" class="purchase_item"><span class="f-fallback">{{$data['video_call']['unique_id']}}</span></td>
