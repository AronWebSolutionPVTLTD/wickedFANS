                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <h5 class="sub-title">{{tr('btcpay_settings')}}</h5>

                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="radio" name="is_btcpay_enabled" value="{{YES}}" id="btcpay_enable" @if(Setting::get('is_btcpay_enabled')==YES ) checked @endif onchange="checkBtcpaySettings(this.value)">
                                    <label for="btcpay_enable">
                                        {{ tr('enable') }}
                                    </label>

                                    <input type="radio" name="is_btcpay_enabled" value="{{NO}}" id="btcpay_disable" @if(Setting::get('is_btcpay_enabled')==NO ) checked @endif onchange="checkBtcpaySettings(this.value)">
                                    <label for="btcpay_disable">
                                        {{ tr('disable') }}
                                    </label>
                            ...
                            <div class="col-lg-6 btcpay_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp">
                                <div class=" form-group">
                                    <label for="BTCPAY_MODE">{{tr('btcpay_mode')}}</label>

                                    <div class="clearfix"></div>

                                    <input type="radio" name="BTCPAY_MODE" value="{{LIVE}}" id="btcpay_live" @if($env_values['BTCPAY_MODE']==LIVE ) checked @endif onchange="checkBtcpayType(this.value)">
                                    <label for="btcpay_live">
                                        {{ tr('btcpay_live') }}
                                    </label>

                                    <input type="radio" name="BTCPAY_MODE" value="{{TEST}}" id="btcpay_test" @if($env_values['BTCPAY_MODE']==TEST ) checked @endif onchange="checkBtcpayType(this.value)">
                                    <label for="btcpay_test">
                                        {{ tr('btcpay_test') }}
                                    </label>
                            ...
                            <div class="col-lg-6 btcpay_settings btcpay_test_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp @php echo ($env_values['BTCPAY_MODE']==LIVE) ? 'hidden' : ''; @endphp">
                                <div class="form-group">

                                    <label for="btcpay_test_endpoint">{{tr('btcpay_test_endpoint')}} *</label>

                                    <input type="text" class="form-control" id="btcpay_test_endpoint" name="btcpay_test_endpoint" placeholder="Enter {{tr('btcpay_test_endpoint')}}" value="{{old('btcpay_test_endpoint') ?: Setting::get('btcpay_test_endpoint')}}">
                            ...
                            <div class="col-lg-6 btcpay_settings btcpay_test_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp @php echo ($env_values['BTCPAY_MODE']==LIVE) ? 'hidden' : ''; @endphp">
                                <div class="form-group">
                                    ...
                                    <label for="btcpay_test_api_key">{{tr('btcpay_test_api_key')}} *</label>

                                    <input type="text" class="form-control" id="btcpay_test_api_key" name="btcpay_test_api_key" placeholder="Enter {{tr('btcpay_test_api_key')}}" value="{{old('btcpay_test_api_key') ?: Setting::get('btcpay_test_api_key')}}">
                            ...
                            <div class="col-lg-6 btcpay_settings btcpay_test_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp @php echo ($env_values['BTCPAY_MODE']==LIVE) ? 'hidden' : ''; @endphp">
                                <div class="form-group">
                                    <label for="btcpay_test_store_id">{{tr('btcpay_test_store_id')}} *</label>

                                    <input type="text" class="form-control" id="btcpay_test_store_id" name="btcpay_test_store_id" placeholder="Enter {{tr('btcpay_test_store_id')}}" value="{{old('btcpay_test_store_id') ?: Setting::get('btcpay_test_store_id')}}">
                                </div>

                            </div>

                            <div class="col-lg-6 btcpay_settings btcpay_live_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp @php echo ($env_values['BTCPAY_MODE']==TEST) ? 'hidden' : ''; @endphp">
                                <div class="form-group">

                                    <label for="btcpay_live_endpoint">{{tr('btcpay_live_endpoint')}} *</label>

                                    <input type="text" class="form-control" id="btcpay_live_endpoint" name="btcpay_live_endpoint" placeholder="Enter {{tr('btcpay_live_endpoint')}}" value="{{old('btcpay_live_endpoint') ?: Setting::get('btcpay_live_endpoint')}}">
                            ...
                            <div class="col-lg-6 btcpay_settings btcpay_live_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp @php echo ($env_values['BTCPAY_MODE']==TEST) ? 'hidden' : ''; @endphp">
                                <div class="form-group">
                                    ...
                                    <label for="btcpay_live_api_key">{{tr('btcpay_live_api_key')}} *</label>

                                    <input type="text" class="form-control" id="btcpay_live_api_key" name="btcpay_live_api_key" placeholder="Enter {{tr('btcpay_live_api_key')}}" value="{{old('btcpay_live_api_key') ?: Setting::get('btcpay_live_api_key')}}">
                            ...
                            <div class="col-lg-6 btcpay_settings btcpay_live_settings @php echo (Setting::get('is_btcpay_enabled')==NO) ? 'disabled' : ''; @endphp @php echo ($env_values['BTCPAY_MODE']==TEST) ? 'hidden' : ''; @endphp">
                                <div class="form-group">
                                    <label for="btcpay_live_store_id">{{tr('btcpay_live_store_id')}} *</label>

                                    <input type="text" class="form-control" id="btcpay_live_store_id" name="btcpay_live_store_id" placeholder="Enter {{tr('btcpay_live_store_id')}}" value="{{old('btcpay_live_store_id') ?: Setting::get('btcpay_live_store_id')}}">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="radio" name="is_stripe_enabled" value="{{YES}}" id="stripe_enable" @if(Setting::get('is_stripe_enabled')==YES ) checked @endif onchange="checkStripeSettings(this.value)">
                                    <label for="stripe_enable">
                                        {{ tr('enable') }}
                                    </label>

                                    <input type="radio" name="is_stripe_enabled" value="{{NO}}" id="stripe_disable" @if(Setting::get('is_stripe_enabled')==NO ) checked @endif onchange="checkStripeSettings(this.value)">
                                    <label for="stripe_disable">
                                        {{ tr('disable') }}
                                    </label>
                            ...
                            <div class="col-lg-6 stripe_settings @php echo (Setting::get('is_stripe_enabled')==NO) ? 'disabled' : ''; @endphp">
                                <div class=" form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="radio" name="is_paypal_enabled" value="{{YES}}" id="paypal_enable" @if(Setting::get('is_paypal_enabled')==YES ) checked @endif onchange="checkPaypalSettings(this.value)">
                                    <label for="paypal_enable">
                                        {{ tr('enable') }}
                                    </label>

                                    <input type="radio" name="is_paypal_enabled" value="{{NO}}" id="paypal_disable" @if(Setting::get('is_paypal_enabled')==NO ) checked @endif onchange="checkPaypalSettings(this.value)">
                                    <label for="paypal_disable">
                                        {{ tr('disable') }}
                                    </label>
                            ...
                            <div class="col-lg-6 paypal_settings @php echo (Setting::get('is_paypal_enabled')==NO) ? 'disabled' : ''; @endphp">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-muted">{{tr('admin_commission_note')}}</p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="product_admin_commission">{{tr('product_admin_commission')}} (%)</label>
                                    <p class="text-muted">{{tr('product_admin_commission')}}</p>
                                    <input type="text" class="form-control" name="product_admin_commission" pattern="[0-9]{0,}" value="{{Setting::get('product_admin_commission')  }}" id="product_admin_commission" placeholder="{{tr('product_admin_commission')}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <h5 class="sub-title">{{tr('withdrawal_settings')}}</h5>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="user_withdrawals_min_amount">{{tr('user_withdrawals_min_amount')}}</label>
                                    <input type="number" min="0" step="any" class="form-control" name="user_withdrawals_min_amount" pattern="[0-9]{0,}" value="{{Setting::get('user_withdrawals_min_amount')  }}" id="user_withdrawals_min_amount" placeholder="{{tr('user_withdrawals_min_amount')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="user_withdrawals_min_balance">{{tr('user_withdrawals_min_balance')}}</label>
                                    <input type="number" min="0" step="any" class="form-control" name="user_withdrawals_min_balance" pattern="[0-9]{0,}" value="{{Setting::get('user_withdrawals_min_balance')  }}" id="user_withdrawals_min_balance" placeholder="{{tr('user_withdrawals_min_balance')}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="FCM_SENDER_ID" id="FCM_SENDER_ID" value="{{old('FCM_SENDER_ID') ?: envfile('FCM_SENDER_ID') }}" placeholder="{{ tr('user_fcm_sender_id') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="FCM_SERVER_KEY" id="FCM_SERVER_KEY" value="{{old('FCM_SERVER_KEY') ?: envfile('FCM_SERVER_KEY') }}" placeholder="{{ tr('user_fcm_server_key') }}">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function checkBtcpaySettings(val) {
        if (val == '1') {
            $(".btcpay_settings").removeClass('disabled');
        } else {
            $(".btcpay_settings").addClass('disabled');
        }
    }

    function checkBtcpayType(val) {
        $(".btcpay_live_settings").hide();
        $(".btcpay_test_settings").show();
        if (val == 'live') {
            $(".btcpay_live_settings").show();
            $(".btcpay_test_settings").hide();
        } else {
            $(".btcpay_live_settings").hide();
            $(".btcpay_test_settings").show();
        }
    ...
    function checkStripeSettings(val) {
        if (val == '1') {
            $(".stripe_settings").removeClass('disabled');
        } else {
            $(".stripe_settings").addClass('disabled');
        }
    }

    function checkPaypalSettings(val) {
        if (val == '1') {
            $(".paypal_settings").removeClass('disabled');
        } else {
