            ...
            <div class="card post-payment-sec">
                ...
                <div class="card-header border-bottom border-gray">
                   ...
                   <div class="heading-elements">
                        ...
                        <a href="{{ route('admin.post_payment.excel',['user_id'=>Request::get('user_id'),'search_key'=>Request::get('search_key'),'post_id'=>Request::get('post_id'),'file_format'=>'.csv']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_csv')}}</a>

                        <a href="{{ route('admin.post_payment.excel',['user_id'=>Request::get('user_id'),'search_key'=>Request::get('search_key'),'post_id'=>Request::get('post_id'),'file_format'=>'.xls']) }}" class="btn btn-primary resp-mrg-btm-xs">export {{tr('export_to_xls')}}</a>

                        <a href="{{ route('admin.post_payment.excel',['user_id'=>Request::get('user_id'),'search_key'=>Request::get('search_key'),'post_id'=>Request::get('post_id'),'file_format'=>'.xlsx']) }}" class="btn btn-primary resp-mrg-btm-xs">{{tr('export_to_xlsx')}}</a>
