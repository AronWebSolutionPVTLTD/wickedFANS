...
class UserProductApiController extends Controller
{
    ...
    public function orders_payment_by_wallet(Request $request) {
        ...
        try {
            ...
            $delivery_address->country = $request->country ?? $delivery_address->country;
            ...
            if($user_pay_amount > 0) {
                ...
                if($wallet_payment_response->success) {
                    ...
                    $job_data['order_payments'] = $request->all();

                    $job_data['timezone'] = $this->timezone;

                    $this->dispatch(new \App\Jobs\OrderPaymentJob($job_data));
